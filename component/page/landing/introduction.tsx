...
import Page from "../../../app/(protected)/member/register/page";
      ...
      >
        <div className="w-full flex flex-col pt-32 md:pt-40">
          <div className="flex flex-col space-y-3 w-full">
            <p className="text-xl md:text-3xl font-semibold">엑셀을 대신 회원을 쉽게 관리하고 싶은</p>
            <p className="text-xl md:text-3xl font-semibold">테니스 관장님을 위해 만들었어요</p>
          </div>
