...
const Footer = () => {
  return (
    ...
    <div className="absolute bottom-0 w-full border-t h-24 px-3 md:h-32 py-2 md:py-4 space-y-1 md:space-y-2">
      ...
      <div className="text-gray-400 md:space-x-4 *:px-4 text-xs md:text-base flex items-center">
        <div className="flex items-center !pl-0">
          <span className="pr-2">문의사항</span>
          <Link href={"mailto:memberee@memberee.com"} className="!pl-0">
            memberee@memberee.com
          </Link>
        </div>
        <Link href={"https://github.com/Echchi"}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
            className="size-4 md:size-5 fill-gray-400"
          >
