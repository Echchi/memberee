...
const Loading = () => {
  return (
    <div className="mt-3 flex-col">
      <>
        <div className="flex justify-center items-center mb-3 lg:mb-7 mt-4">
          <div className="skeleton h-16 rounded-lg w-64 mx-auto" />
          <div className="w-16 lg:w-32 skeleton rounded-lg h-14" />
        </div>

        <div className="w-full space-y-4 *:skeleton *:h-14 *:lg:h-16 *:rounded-lg">
