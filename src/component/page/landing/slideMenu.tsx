...
import { useScrollContext } from "@/component/page/landing/scrollProvider";
  ...
  return (
    <>
      <div className="flex fixed top-0 w-full h-16 lg:hidden items-center px-3 md:px-10 bg-white">
        <span className="text-3xl font-extrabold text-blue-800">BlueAI</span>
        <button className="absolute right-10" onClick={() => setMenuOpen(true)}>
          <svg
