      ...
      <div className="flex flex-col grow overflow-y-auto">
        {members.length > 0 ? (
          ...
          <div className="flex flex-col grow px-5 py-2">
            <div className="grow mb-4 flex flex-col items-center justify-center space-y-3 font-semibold text-xl text-stone-400 hover:text-stone-500 transition-all cursor-pointer">
              <p>등록된 회원이 없습니다</p>
              <div className="">
                <svg
